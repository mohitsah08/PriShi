...
export function ReferenceChatPage() {
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="rounded-lg px-1 py-1 text-[20px] font-medium text-black"
                >
                  PriShi
                  <span className="ml-1 text-sm text-black/45">⌄</span>
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {user?.role === 'admin' ? (
                <Link
                  to="/admin"
                  className="rounded-full border border-black/15 bg-white px-4 py-2 text-sm text-black/75"
                >
                  Admin
                </Link>
              ) : null}
