...
export function ChatPage() {
  ...
  return (
    <div className="flex min-h-screen bg-app text-app-text">
      <div className={`${showSidebar ? 'fixed inset-0 z-40 bg-black/70 md:static md:bg-transparent' : 'hidden md:block'}`}>
      ...
      <main className="flex min-h-screen flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <ChatMessageList messages={messages} loading={loadingMessages && Boolean(activeThreadId)} />
